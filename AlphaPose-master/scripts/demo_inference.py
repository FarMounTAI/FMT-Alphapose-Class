...
parser.add_argument('--head_pose', dest='head_pose', default=True, action='store_true',
                    help='head pose')
...
parser.add_argument('--analyse_focus', dest='analyse_focus',
                    help='Concentration', action='store_true', default=True)
parser.add_argument('--show_keypoints', dest='keypoints',
                    help='keypoints', action='store_true', default=True)
parser.add_argument('--Violation of discipline', dest='Violation of discipline',
                    help='Violation of discipline', action='store_true', default=True)
parser.add_argument('--save_cheaters', dest='save_cheaters',
                    help='saveimage', action='store_true', default=True)
parser.add_argument('--classroom_action', dest='classroom_action',
                    help='behavior', action='store_true', default=True)
